    ...
    <section class="relative w-full h-64">
        ...
        <div class="relative z-20 flex items-center justify-center h-full">
            <div class="text-center px-4 md:px-6 lg:px-8 text-white">
                <p class="text-sm mb-1">Program > <span class="font-medium">Mahasantri Al-Khoir </span></p>
                <h1 class="text-xl md:text-2xl font-semibold">Tentang Mahasantri Al-Khoir </h1>
            </div>
        </div>
    </section>
                ...
                <div id="visi-misi">
                    ...
                    <div class="mb-2">
                        ...
                        <p class="italic text-gray-600 text-baseleading-normal">
                            “Mahasantri Al-Khoir  menjadi unggulan yang terdepan dalam membentuk generasi Qurani yang
                ...
                <div class="bg-blue-100 text-blue-900 rounded-lg shadow px-4 py-4 sticky top-20">
                    ...
                    <ul class="space-y-2 text-base text-blue-800">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <a href="#kepsek" class="hover:underline">Ketua Program</a>
                        </li>
                    </ul>
